...
//? With reduce
console.groupCollapsed("Tallying up order totals...");
...
console.groupCollapsed("Tallying up inventory...");
...
const totalInventoryPrice = inventory.reduce((totalPrice, item) => totalPrice + item.price, 0);
